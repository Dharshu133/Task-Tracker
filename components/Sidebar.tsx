                ...
                {isAdmin && (
                  <div className="flex items-center gap-1 transition-all">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        onProjectSelect(`SETTINGS:${project.id}`);
                        onClose();
                      }}
                      className="p-2 text-muted-foreground hover:text-primary rounded-xl hover:bg-primary/10"
                    ...
                    <button
                      ...
                      className="p-2 text-muted-foreground hover:text-destructive rounded-xl hover:bg-destructive/10"
